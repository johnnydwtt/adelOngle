    ...
    <section>
        <div class="container">
            <div class="row justify-content-center text-center flex-column text-dark">
                ...
                <form class="row justify-content-center align-items-center flex-column shadow" action="<?=htmlspecialChars($_SERVER['PHP_SELF'])?>?id=<?=htmlentities($response->customer_id)?>"
                    method="post">
                    ...
                    <div class="col-lg-5 col-12">
                        ...
                        <p class="card-text">
                            ...
                            <input class="form-control input_pass" name="email"
                                value="<?=htmlentities($response->mail)?>" type="mail" pattern="<?=MAIL_REGEX?>"
                                required>
                        ...
                        <p class="card-text">
                            <span class="fw-bold">Mot de passe:</span>
                                ...
                                <a href="/controllers/modifPasswordCtrl.php?id=<?=htmlentities($response->customer_id)?>">
